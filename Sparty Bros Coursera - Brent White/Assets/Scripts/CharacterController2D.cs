...
public class CharacterController2D : MonoBehaviour {
	...
	void Update()
	{
        ...
        else if (_canDoubleJump && CrossPlatformInputManager.GetButtonDown("Jump")) //If Can Double Jump and Jump Button Pressed, then permit Double Jump
        {
            doJumpHalf();
            //Disables Jump to only permit 2nd Jump Once. 
    ...
    void doJumpHalf()
    {
        ...
        _vy = 0f;
        // add a force in the up direction
        _rigidbody.AddForce(new Vector2(0, (jumpForce/(5/3))));
        // play the jump sound
        PlaySound(jumpSFX);
    }
